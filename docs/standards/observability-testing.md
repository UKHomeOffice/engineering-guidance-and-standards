...
- [Focus on key metrics and logs](#focus-on-key-metrics-and-logs)
- [Integrate observability into CI/CD pipelines](#integrate-observability-into-cicd-pipelines)
- [Quality engineering focus: observability in automation with mocks](#quality-engineering-focus-observability-in-automation-with-mocks)
- [Create an effective incident response plan](#create-an-effective-incident-response-plan)
- [Develop centralised logging](#develop-centralised-logging)
- [Define key performance indicators](#define-key-performance-indicators)
